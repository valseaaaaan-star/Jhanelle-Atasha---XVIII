...
const revealElements =
    document.querySelectorAll(
        ".intro-inner, .preview-frame, .event-intro, .details-header, .detail-item, .venue-map-frame, .dress-inner, .wishlist-scroll, .wishlist-item, .tradition-card, .wishes-carousel, .gallery-wrap, .rsvp, .final"
    );
